...
import WordCountWorker from 'worker-loader!./works/wordCount?worker&inline'
import CatalogWorker from 'worker-loader!./works/catalog?worker&inline'
import GroupWorker from 'worker-loader!./works/group?worker&inline'
